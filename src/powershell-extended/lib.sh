...
export POWERSHELL_UPDATE_MODULESHELP=${UPDATEMODULESHELP:-"true"}
export POWERSHELL_USER_DEFAULT_SHELL="${SETUSERDEFAULTSHELL:-"false"}"
export POWERSHELL_ROOT_DEFAULT_SHELL="${SETROOTDEFAULTSHELL:-"false"}"
export POWERSHELL_PROFILE_URL="${PROFILEURLALLUSERSALLHOSTS:-""}"
export POWERSHELL_CONFIG_URL="${PSCONFIGURLALLUSERSALLHOSTS:-""}"
export POWERSHELL_CONFIG_EXPERIMENTALFEATURES="${PSCONFIGEXPERIMENTALFEATURES:-""}"
